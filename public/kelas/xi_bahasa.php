...
$siswa = tampil("SELECT * FROM `siswa` WHERE `kelas` LIKE 'XI' AND `program` LIKE 'Bahasa' ORDER BY nama ASC");
...
<body>
     ...
     <div class="container-fluid">
          ...
          <div class="alert alert-dark justify-content-start mt-3 bg-dark text-warning" role="alert">
               MAN 1 SUMENEP/KELAS : XI/PROGRAM : BAHASA.
          </div>
          <!-- akhir judul data -->
